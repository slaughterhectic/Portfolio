...
export default class Resources extends EventEmitter
{
    constructor()
    {
        ...
        this.loader.load([
            ...
            { name: 'introDBase', source: './models/intro/d/base1.glb' },
            ...
            { name: 'introABase', source: './models/intro/u/base1.glb' },
            { name: 'introACollision', source: './models/intro/u/collision1.glb' },

            { name: 'introNBase', source: './models/intro/a/base.glb' },
            { name: 'introNCollision', source: './models/intro/a/collision.glb' },
            

            { name: 'introUBase', source: './models/intro/u/base2.glb' },
            { name: 'introUCollision', source: './models/intro/u/collision.glb' },

            { name: 'introNBase', source: './models/intro/r/base1.glb' },
            { name: 'introNCollision', source: './models/intro/r/collision1.glb' },

            { name: 'introHBase', source: './models/intro/h/base.glb' },
            { name: 'introHCollision', source: './models/intro/h/collision.glb' },

            { name: 'introSBase', source: './models/intro/s/base1.glb' },
